...
int entrada_carro(Fila P, int sina){
    ...
    do{
        ...
        while(A.placa[i] != '\0'){
            if(A.placa[i] >= 'A' && A.placa[i] <= 'Z')
                cont1++;
            else if(A.placa[i] >= '0' && A.placa[i] <= '9'){
                    cont2++;
            }
            i++;
        }
        if(cont1 != 4 && cont2 != 3 && (cont1 + cont2) != 7)
    ...
    }while(cont1 != 4 && cont2 != 3 && (cont1 + cont2) != 7);
    do{
...
int main()
{
    int sina1 = 0, sina2 = 0, sina3 = 0, sina4 = 0, sina5 = 0;
    int espera = 0;
    ...
    do {
        ...
        switch (swi) {
            case 1: {
                if(sina1 <= sina2 && sina1 <= sina3 && sina1 <= sina4 && sina1 <= sina5 && sina1 < 1){
                ...
                if(sina2 <= sina3 && sina2 <= sina4 && sina2 <= sina5 && sina2 < 1){
                ...
                if(sina3 <= sina4 && sina3 <= sina5 && sina3 < 1){
                ...
                if(espera < 2){
                    printf("O estacionamento esta cheio no momento...Seu carro sera colocado na lista de espera na posicao %d de 10 e assim que vagas forem desocupadas e for a sua vez, seu carro podera ser estacionado", espera+1);
            ...
            case 2: {
                int contador = 0; // se nenhuma fila possuir a placa do carro a ser removido, contador continuara 0 e o programa emitira uma mensagem de erro
                ...
                if(saida_carro(S, C, E, espera) == 2){
                    ...
                    contador++;
                if(contador == 0)
                    printf("\nEsta placa nao foi encontrada nos carros do estacionamento...(Uma placa possui 7 algarismos que podem somente ser letras do alfabeto ou numeros de 0 a 9) \n");
                break;
            }
            case 3: {
                int cont = 1;
